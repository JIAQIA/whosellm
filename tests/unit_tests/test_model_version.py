...
class TestModelVersion(unittest.TestCase):
    ...
    def test_provider_detection(self) -> None:
        ...
        # OpenAI
        assert LLM("gpt-4").provider == Provider.OPENAI
        assert LLM("gpt-3.5-turbo").provider == Provider.OPENAI

        # 智谱 AI
        assert LLM("glm-4").provider == Provider.ZHIPU
        assert LLM("glm-4v-plus").provider == Provider.ZHIPU
    ...
    def test_same_model_different_providers(self) -> None:
        ...
        model_openai = LLM("openai::gpt-4")
        model_default = LLM("gpt-4")
    ...
    def test_release_date_comparison(self) -> None:
        ...
        # 同一型号不同日期的比较
        model_old = LLM("gpt-4-turbo-2024-01-01")
        model_new = LLM("gpt-4-turbo-2024-04-09")
        ...
        model_no_date = LLM("gpt-4-turbo")
        model_with_date = LLM("gpt-4-turbo-2024-04-09")
    ...
    def test_complex_comparison_with_date(self) -> None:
        ...
        # 创建不同版本、型号和日期的模型
        gpt4_base_with_date = LLM("gpt-4-0125-preview")  # base, 2024-01-25
        gpt4_base_no_date = LLM("gpt-4")  # base, no date
        gpt4_turbo_with_date = LLM("gpt-4-turbo-2024-04-09")  # turbo, 2024-04-09
        gpt4_turbo_no_date = LLM("gpt-4-turbo")  # turbo, no date
